...
date: 11-17-2020
description: The goal of this challenge is to build a high performing light-weight neural network model that can increase the resolution of a single image (by four times).
image: ../assets/div2kSISR/cover.png
info:
  - text: GitHub
    link: https://github.com/kkaryl/AI6126-Advanced_Computer_Vision/tree/master/project_2
    icon:
      type: lucide
      name: github
---
...
![Non-standard Data Augmentations](../assets/div2kSISR/SISR_data_aug.png)
...
### CARN Architecture
![CARN Architecture](../assets/div2kSISR/CARN.png)
