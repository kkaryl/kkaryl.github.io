...
date: 10-22-2020
description: The goal of this challenge is to build a high performing multi-label classiﬁer to identify the facial attributes in photographs.
image: ../assets/celeba/cover.png
info:
  - text: GitHub
    link: https://github.com/kkaryl/AI6126-Advanced_Computer_Vision/tree/master/project_1
    icon:
      type: lucide
      name: github
---
...
![Frequency distribution](../assets/celeba/eda_freq_dist.png)
...
![Beta distribution](../assets/celeba/beta0.2_dist.png)
